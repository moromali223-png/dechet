...
<div class="container">
    ...
    <form action="{{ route('produits.store') }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="number" step="0.01" name="quantite" id="quantite" class="form-control" value="{{ old('quantite') }}" required>
        </div>

        <div class="mb-3">
            <label for="prix_unitaire">Prix unitaire (FCFA)</label>
            <input type="number" step="0.01" name="prix_unitaire" id="prix_unitaire" class="form-control" value="{{ old('prix_unitaire') }}" required>
        </div>
