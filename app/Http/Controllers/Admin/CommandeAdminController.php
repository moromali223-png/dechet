 ...
 public function index(Request $request)
{
    ...
    $commandes = Commande::with(['client', 'produitRelation'])
    ...
    {
        $commande->load(['client', 'produitRelation', 'paiements']);
   ...
   public function accepter(Commande $commande)
{
    ...
    {
        $paiements = Paiement::with('commande.client')->latest()->paginate(15);
